...
/**
 * Stores previously logged fish species names on-device so add/edit-catch screens can suggest them
 ...
 */
class SpeciesManagerImpl @Inject constructor(private val context: Context) : SpeciesManager {
