...
class LocalUserManagerImpl @Inject constructor(private val context: Context) : LocalUserManager {
    ...
    override suspend fun saveAppEntry() {
        context.dataStore.edit { settings -> settings[PreferenceKeys.APP_ENTRY] = true }
    }
    ...
    override suspend fun deleteAppEntry() {
        context.dataStore.edit { settings -> settings[PreferenceKeys.APP_ENTRY] = false }
    }

    override suspend fun saveUserSignedIn() {
        context.dataStore.edit { settings -> settings[PreferenceKeys.USER_SIGNED_IN] = true }
    }
    ...
    override suspend fun deleteUserSignedIn() {
        context.dataStore.edit { settings -> settings[PreferenceKeys.USER_SIGNED_IN] = false }
    }
}
