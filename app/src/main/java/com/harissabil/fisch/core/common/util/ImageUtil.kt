 ...
 *
 * Camera photos come in at full sensor resolution (e.g. 3000x4000px); compressing that at a
 * fixed JPEG quality alone barely reduces file size. Downscaling first is what actually keeps
 * uploads small.
 */
