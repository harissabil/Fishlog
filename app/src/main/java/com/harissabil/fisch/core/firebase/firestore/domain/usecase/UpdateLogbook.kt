...
class UpdateLogbook @Inject constructor(private val firestoreRepository: FirestoreRepository) {
    suspend operator fun invoke(logbook: Logbook, fishImage: Bitmap?, lat: Double?, lon: Double?) =
