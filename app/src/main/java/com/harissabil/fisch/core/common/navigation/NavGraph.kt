...
fun NavGraph(startDestination: String) {
    ...
    NavHost(navController = navController, startDestination = startDestination) {
        navigation(
            ...
            composable(route = Route.OnBoardingScreen.route) { OnBoardingScreen() }
        }
        ...
        navigation(
            ...
            composable(route = Route.SignInScreen.route) { SignInScreen() }
        }
        ...
        navigation(
            ...
            composable(route = Route.MainNavigator.route) { MainNavigator() }
        }
    }
}
